...
> **💡 Pro Tip**: All features in this guide can be tested interactively! Every story includes comprehensive Storybook controls that let you experiment with settings in real-time without writing code. Jump to the [Interactive Testing & Exploration](#interactive-testing--exploration) section to learn how.
...
<Canvas>
  <Story of={RestrictionStories.DateRangeRestrictions} />
</Canvas>
...
**🎛️ All CLACalendar features can be tested interactively using Storybook controls!**
