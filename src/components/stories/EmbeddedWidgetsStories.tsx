...
export const FlatSingleMonthStory = () => (
  <CLACalendar 
    settings={{
      ...getDefaultSettings(),
...
export const FourMonthViewStory = () => (
  <CLACalendar 
    settings={{
      ...getDefaultSettings(),
      displayMode: 'embedded',
...
export const MinimalEmbeddedStory = () => (
  <CLACalendar 
    settings={{
      ...getDefaultSettings(),
      displayMode: 'embedded',
...
export const CompactEmbeddedStory = () => (
  <CLACalendar 
    settings={{
      ...getDefaultSettings(),
      displayMode: 'embedded',
...
export const EmbeddedWithLayersStory = () => (
  <CLACalendar 
    settings={{
      ...getDefaultSettings(),
      displayMode: 'embedded',
...
export const ThreeMonthNoSubmitStory = () => (
  <CLACalendar 
    settings={{
      ...getDefaultSettings(),
      displayMode: 'embedded',
...
export const FormIntegrationStory = () => (
  <div style={{ 
    padding: '20px', 
...
export const DashboardWidgetStory = () => (
  <div style={{ 
...
export const YearRoundCalendarStory = () => {
