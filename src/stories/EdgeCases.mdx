...
<Meta title="Edge Cases/Configuration Stress Tests/Documentation" />

# Configuration Stress Tests Documentation
...
> **Note**: To see these edge cases in action with actual calendar instances, visit the "Direct Rendering" page under this section.
...
1. Visit the "Direct Rendering" page under Configuration Stress Tests
...
3. Add the test to the Direct Rendering page
